...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} | {{title_case(trans('menu.register'))}}</title>
    <!-- Styles -->
    ...
    <div class="column is-8 is-hidden-mobile hero-banner">
        <section class="hero is-fullheight is-dark">
            ...
            <div class="hero-footer">
                <p class="has-text-centered">Image © IDProtect - 2017 - Joy NDJAMA</p>
            </div>
        </section>
    </div>
                ...
                <div class="container">
                    <div class="columns">
                        <div class="column is-8 is-offset-2" >
                            ...
                            @endif
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}" style="margin-top: 10px ">
                                {{ csrf_field() }}
                                <div class="login-form">
                                    <div class="field {{ $errors->has('name') ? ' is-danger' : '' }}">
                                        <p class="control has-icon has-icon-right">
                                            <input id="name" class="input email-input" type="text" name="name" value="{{ old('name') }}" placeholder="@lang('messages.register1')" required autofocus>
                                    ...
                                    <div class="field">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="terms" required> @lang('messages.register5')
                                                    <a href="#">@lang('messages.register6')</a> @lang('messages.register7')  <a href="#">@lang('messages.register8')</a>
                                            </label>
                                        </div>
                                    </div>
